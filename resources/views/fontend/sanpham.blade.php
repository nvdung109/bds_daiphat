                        ...
                        <div class="col-lg-5 col-md-5 col-pad">
                            <div class="property-thumbnail">
                                <a href="properties-details.html" class="property-img">
                                    <img src="fontend/img/properties/properties-list-1.jpg" alt="properties" class="img-fluid">
                                    <div class="price-box"><span>1.5 - 2 tỷ (VNĐ)</span></div>
                                </a>
                            </div>
                        </div>
                                ...
                                <div class="hdg">
                                    ...
                                    <h5 class="location">
                                        <a href="properties-details.html">
                                            <i class="flaticon-pin"></i>Đại lộ thăng long - Hà Nội
                                        </a>
                                    </h5>
                                </div>
                                <ul class="facilities-list clearfix">
                                    <li>
                                        <span>Diện tích</span>3600m
                                    </li>
                                    <li>
                                        <span>Loại đất</span> 3
                                    </li>
                                </ul>
                                <div class="footer">
                                    <a href="#" tabindex="0">
                                        <i class="flaticon-male"></i>Admin
                                    </a>
                                    <span>
                                          <i class="flaticon-calendar"></i>8/3/2021
                                    </span>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from storage.googleapis.com/theme-vessel/checking-sites/neer-html/HTML/properties-list-rightside.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Mar 2021 03:10:37 GMT -->
</html>